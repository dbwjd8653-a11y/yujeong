...
# 토큰 사용량 페이지 반복 조회 부하 테스트 — FHC-106
...
@allure.title("[FHC-106] 토큰 사용량 페이지 반복 조회 부하 테스트")
@allure.severity(allure.severity_level.NORMAL)
def test_token_page_load(token_load):
    """
    [FHC-106] 토큰 사용량 페이지 반복 조회 부하 테스트
    ...
    """
    logger.info("[FHC-106] 토큰 사용량 반복 조회 부하 테스트 시작")
    fail_count = 0
    ...
    logger.info("[FHC-106] 토큰 사용량 반복 조회 부하 테스트 완료")
