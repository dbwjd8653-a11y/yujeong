...
@allure.title("[FHC-105] 마이페이지 탭 반복 이동 부하 테스트")
@allure.severity(allure.severity_level.NORMAL)
def test_mypage_tab_load(mypage_load):
    """
    [FHC-105] 마이페이지 탭 반복 이동 부하 테스트
    ...
    관련 TC: FHC-076, FHC-077, FHC-089, FHC-097, FHC-100
    """
    logger.info("[FHC-105] 마이페이지 탭 반복 이동 부하 테스트 시작")
    ...
    logger.info("[FHC-105] 마이페이지 탭 반복 이동 부하 테스트 완료")
